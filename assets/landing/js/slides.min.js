...
function register () {
    console.log('pressed')
    $('#registerComponent').removeClass('displayNone')
    $('#loginComponent').addClass('displayNone')
  }

  function signIn () {
    console.log('pressed')
    $('#registerComponent').addClass('displayNone')
    $('#loginComponent').removeClass('displayNone')
  }